...
local function HeartbeatUpdate()
    ...
    FpsLabel.Text = ("小泷时间:"..os.date("%H").."时"..os.date("%M").."分"..os.date("%S"))
end
Start = tick()
...
about:Label("作者：泷")
about:Label("进群发最新泷脚本")
about:Label("脚本持续更新中")
about:Label("帮助者:月星,小皮,lishichuan丁丁")
about:Label("月星,小皮,lishichuan丁丁是泷一辈子的恩人")
about:Label("脚本懒得优化")
about:Label("欢迎使用🤓")
...
local UITab5 = win:Tab("『复制泷脚本群系列』",'16060333448')
...
about:Button("泷自瞄（死亡消失）",function()
